...
final class PaginationSelector extends StatefulWidget {
  ...
  /// Creates a new [PaginationSelector] instance.
  ...
  @override
  State<PaginationSelector> createState() => _PaginationState();
}
...
final class _PaginationState extends State<PaginationSelector> with ThemingStateMixin<PaginationSelector> {
  ...
  @override
  void didUpdateWidget(covariant PaginationSelector oldWidget) {
