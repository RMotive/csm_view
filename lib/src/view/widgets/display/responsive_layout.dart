...
/// Widget class for [ResponsiveLayout].
///
/// Defines UI for a [ResponsiveLayout] implementation.
///
/// [ResponsiveLayout] concept: handle draw decission based on specific width window breakpoints, specifying what to draw when
...
final class ResponsiveLayout extends StatelessWidget {
  ...
  /// Generates a new [ResponsiveLayout] widget.
