...
/// Widget class for [DataTable].
///
/// Defines UI for a [DataTable] implementation.
///
/// [TData] - The type of each data entry that the table will draw.
///
/// [DataTable] concept: draws a standard base UI for a data table.
final class DataTable<TData> extends StatelessWidget {
  ...
  /// Generates a new [DataTable] widget.
  const DataTable({
    super.key,
