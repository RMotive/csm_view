import 'package:csm_view/src/common/extensions/string_extensions.dart';
...
mixin ConsoleMixin {
  ...
  void _advise(String message, Color color, {Map<String, dynamic>? info, bool startWithUpper = true}) {
  ...
  String _formatMessage(String message, Color color, {bool startWithUpper = true, bool includeTag = false}) {
